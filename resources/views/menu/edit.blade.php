            ...
            <div class="card-body">
                ...
                <form action="{{ route('menu.update', $menu->id_menu) }}" method="POST">
                    ...
                    <!-- <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="menu_category" id="menu_category" onchange="toggleSubMenuField()">
                    ...
                    <div id="hidden_div" @if ($menu->menu_category == "master menu") style="display: none;" @endif>
                        <div class="form-group row">
...
@section('scripts')
    ...
    <script>
        function toggleSubMenuField() {
            var menuCategoryField = document.getElementById('menu_category');
            var subMenuDiv = document.getElementById('hidden_div');

            // Jika kategori menu yang dipilih adalah 'Sub Menu', maka tampilkan dropdown sub menu
            if (menuCategoryField.value === 'sub menu') {
                subMenuDiv.style.display = 'block';
            } else {
                subMenuDiv.style.display = 'none';
            }
